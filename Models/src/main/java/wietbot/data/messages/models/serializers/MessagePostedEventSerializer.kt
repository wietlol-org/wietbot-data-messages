...
import wietbot.data.messages.models.builders.MessagePostedEventBuilder
import wietbot.data.messages.models.models.*
import wietbot.data.messages.models.models.MessagePostedEvent
...
object MessagePostedEventSerializer : ModelSerializer<MessagePostedEvent, MessagePostedEvent>
{
	...
	override fun deserialize(deserializationContext: DeserializationContext, stream: InputStream, schema: Schema): MessagePostedEvent
	{
		...
		while (true)
		{
			...
			{
				endOfObject -> return DefaultMessagePostedEvent(
					id!!,
					timeStamp!!,
					messageId!!,
					content!!,
