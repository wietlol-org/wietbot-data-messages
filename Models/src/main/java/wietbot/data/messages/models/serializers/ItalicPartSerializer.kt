...
import wietbot.data.messages.models.builders.ItalicPartBuilder
import wietbot.data.messages.models.models.*
import wietbot.data.messages.models.models.ItalicPart
...
object ItalicPartSerializer : ModelSerializer<ItalicPart, ItalicPart>
{
	...
	override val modelId: UUID
		get() = ItalicPart.serializationKey
	
	override val dataClass: Class<ItalicPart>
		get() = ItalicPart::class.java
	
	override fun serialize(serializationContext: SerializationContext, stream: OutputStream, schema: Schema, entity: ItalicPart)
	{
	...
	override fun deserialize(deserializationContext: DeserializationContext, stream: InputStream, schema: Schema): ItalicPart
	{
		...
		while (true)
		{
			...
			{
				endOfObject -> return DefaultItalicPart(
					inner!!,
				)
