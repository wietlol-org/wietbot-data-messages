...
import wietbot.data.messages.models.builders.TextPartBuilder
import wietbot.data.messages.models.models.*
import wietbot.data.messages.models.models.TextPart
...
object TextPartSerializer : ModelSerializer<TextPart, TextPart>
{
	...
	override val modelId: UUID
		get() = TextPart.serializationKey
	
	override val dataClass: Class<TextPart>
		get() = TextPart::class.java
	
	override fun serialize(serializationContext: SerializationContext, stream: OutputStream, schema: Schema, entity: TextPart)
	{
	...
	override fun deserialize(deserializationContext: DeserializationContext, stream: InputStream, schema: Schema): TextPart
	{
		...
		while (true)
		{
			...
			{
				endOfObject -> return DefaultTextPart(
					text!!,
				)
